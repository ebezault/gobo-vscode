...
![Create ECF File](../images/create_ecf_file.gif)

You can then edit this ECF file and customize it. Learn more about ECF files in the [Gobo Eiffel documentation](https://www.gobosoft.com/eiffel/gobo/library/tools/doc/ecf.html).
